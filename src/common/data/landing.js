...
const reviews = [
  {
    ...
    name: 'Thomas Israel',
    post: 'C.E.O',
    desc: 'The commmissioning of the warehouse went smoothly. Jarvis Link made the implementation of controls simple and easy. Thank you!',
    rating: 5,
  },
  {
    id: 2,
    ...
    post: 'V.P',
    desc: 'With Jarvis Link we do most of our commissioning from our office which is really convenient and efficient.',
    rating: 4.5,
  },
  {
    id: 3,
    ...
    name: 'Carl Oliver',
    post: 'Sales Manager',
    desc: 'Jarvis Link opened up an opportunity for us to offer lighting controls and expand our marketshare.',
    rating: 5,
  },
  // {
  //   id: 4,
...
const onepageFeaturesData = [
  {
    ...
    description:
      'You can add any number of floor plans to your project. Each plan will become a separate "area".',
  },
  {
    id: 2,
    icon: 'uil uil-vector-square h2 text-primary',
    title: 'Create lighting zones',
    description:
      'A zone is a group of lighting devices that operate together to realize a specific lighting control behavior.',
  },
  {
    id: 3,
    icon: 'uil uil-file-search-alt h2 text-primary',
