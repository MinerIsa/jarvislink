...
import Index from '../pages/JarvisLink/index';
...
// import SaasOnepage from '../pages/JarvisLink/index';
...
const routes = [
  ...
  //   component: HostingDedicated,
  //   isWithoutLayout: true,
  // },
  // { path: '/hosting-cloud', component: HostingCloud, isWithoutLayout: true },
  // {
  //   path: '/hosting-reseller',
  //   component: HostingReseller,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/hosting-aboutus',
  //   component: HostingAboutus,
  //   isWithoutLayout: true,
  // },
  // {
  ...
  // {
  //   path: '/hosting-blog-detail',
  //   component: HostingBlogDetail,
  //   isWithoutLayout: true,
  // },
  ...
  // {
  //   path: '/crypto-whitepaper',
  //   component: CryptoWhitepaper,
  //   isWithoutLayout: true,
  // },
  // { path: '/crypto-blog', component: CryptoBlog, isWithoutLayout: true },
  // {
  //   path: '/crypto-blog-detail',
  //   component: CryptoBlogDetail,
  //   isWithoutLayout: true,
  // },
  ...
  // {
  //   path: '/shop-fullwidth-grids',
  //   component: ShopFullwidthGrids,
  //   isWithoutLayout: true,
  // },
  // { path: '/shop-grids', component: ShopGrid, isWithoutLayout: true },
  // {
  //   path: '/shop-fullwidth-lists',
  //   component: ShopFullwidthLists,
  //   isWithoutLayout: true,
  // },
  ...
  //   component: PageWorkModernTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-modern-three',
  //   component: PageWorkModernThree,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-modern-four',
  //   component: PageWorkModernFour,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-modern-five',
  //   component: PageWorkModernFive,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-modern-six',
  //   component: PageWorkModernSix,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-classic-two',
  //   component: PageWorkClassicTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-classic-three',
  //   component: PageWorkClassicThree,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-classic-four',
  //   component: PageWorkClassicFour,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-classic-five',
  //   component: PageWorkClassicFive,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-classic-six',
  //   component: PageWorkClassicSix,
  //   isWithoutLayout: true,
  // },

  // {
  //   path: '/portfolio-grid-two',
  //   component: PageWorkGridTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-grid-three',
  //   component: PageWorkGridThree,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-grid-four',
  //   component: PageWorkGridFour,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-grid-five',
  //   component: PageWorkGridFive,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-grid-six',
  //   component: PageWorkGridSix,
  //   isWithoutLayout: true,
  // },

  // {
  //   path: '/portfolio-masonry-two',
  //   component: PageWorkMasonryTwo,
  //   isTopbarDark: true,
  // },

  // {
  //   path: '/portfolio-detail-one',
  //   component: PageWorkDetailOne,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-detail-two',
  //   component: PageWorkDetailTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-detail-three',
  //   component: PageWorkDetailThree,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-detail-four',
  //   component: PageWorkDetailFour,
  //   isWithoutLayout: true,
  // },
  ...
  // {
  //   path: '/portfolio-page-masonry-two',
  //   component: PageMasonryTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-masonry-three',
  //   component: PageMasonryThree,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-masonry-Four',
  //   component: PageMasonryFour,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-masonry-Five',
  //   component: PageMasonryFive,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/portfolio-masonry-Six',
  //   component: PageMasonrySix,
  //   isWithoutLayout: true,
  // },
  ...
  // {
  //   path: '/job-detail-two',
  //   component: PageJobDetailTwo,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/job-detail-three',
  //   component: PageJobDetailThree,
  //   isWithoutLayout: true,
  // },
  // { path: '/job-apply', component: PageJobApply, isWithoutLayout: true },
  // {
  //   path: '/job-candidate-list',
  //   component: PageCandidateList,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/job-candidate',
  //   component: PageJobCandidate,
  //   isWithoutLayout: true,
  // },
  // {
  //   path: '/job-company-list',
