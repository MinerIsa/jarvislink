    ...
    child: [
      {
        ...
        link: '/#',
        icon: 'uil uil-book-open fs-6 align-middle',
        isHeaderClass: true,
      },
...

      {
        ...
        header: 'Full Demos',
        link: '/#',
        icon: 'uil uil-cube fs-6 align-middle',
        isHeaderClass: true,
      },
        ...
        child: [
          ...
          },
          {
            ...
            child: [
              ...
              {
                title: 'Reset Pass Five',
                link: '/auth-reset-password-bg-video',
              },
            ],
          },
        ],
    ...
    child: [
      {
        subTitle: 'Buttons',
        link: '/ui-button',
        iconClass: 'uil uil-cube fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Badges',
        link: '/ui-badges',
        iconClass: 'uil uil-award fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Alert',
        link: '/ui-alert',
        iconClass: 'uil uil-info-circle fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Dropdowns',
        link: '/ui-dropdown',
        iconClass: 'uil uil-layers fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Typography',
        link: '/ui-typography',
        iconClass: 'uil uil-align-center-alt fs-6 align-middle me-1',
        isMenu: true,
      },

      {
        subTitle: 'Background',
        link: '/ui-background',
        iconClass: 'uil uil-palette fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Text Color',
        link: '/ui-text',
        iconClass: 'uil uil-text fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Accordions',
        link: '/ui-accordion',
        iconClass: 'uil uil-list-ui-alt fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Cards',
        link: '/ui-card',
        iconClass: 'uil uil-postcard fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Tooltips & Popovers',
        link: '/ui-tooltip-popover',
        iconClass: 'uil uil-backspace fs-6 align-middle me-1',
        isMenu: true,
      },

      {
        subTitle: 'Shadows',
        link: '/ui-shadow',
        iconClass: 'uil uil-square-full fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Border',
        link: '/ui-border',
        iconClass: 'uil uil-border-out fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Carousel',
        link: '/ui-carousel',
        iconClass: 'uil uil-sliders-v fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Form Elements',
        link: '/ui-form',
        iconClass: 'uil uil-notes fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Breadcrumb',
        link: '/ui-breadcrumb',
        iconClass: 'uil uil-sort-amount-down fs-6 align-middle me-1',
        isMenu: true,
      },

      {
        subTitle: 'Pagination',
        link: '/ui-pagination',
        iconClass: 'uil uil-copy fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Avatars',
        link: '/ui-avatar',
        iconClass: 'uil uil-image fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Nav Tabs',
        link: '/ui-nav-tabs',
        iconClass: 'uil uil-bars fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Modals',
        link: '/ui-modals',
        iconClass: 'uil uil-vector-square fs-6 align-middle me-1',
        isMenu: true,
      },

      {
        subTitle: 'Tables',
        link: '/ui-tables',
        iconClass: 'uil uil-table fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Icons',
        link: '/ui-icons',
        iconClass: 'uil uil-shutter-alt fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Progressbar',
        link: '/ui-progressbar',
        iconClass: 'uil uil-brackets-curly fs-6 align-middle me-1',
        isMenu: true,
      },
      {
        subTitle: 'Lightbox',
        link: '/ui-lightbox',
        iconClass: 'uil uil-play-circle fs-6 align-middle me-1',
        isMenu: true,
      },
    ],
  },
